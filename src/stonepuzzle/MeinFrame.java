...
public class MeinFrame extends JFrame implements KeyListener {
    ...
    public void paintView(){
        ...
        //加载胜利图片资源，添加到窗体中
        if(victory()){
            JLabel winLabel = new JLabel(new ImageIcon("C:\\Users\\Student\\Desktop\\Coding\\javasepro\\Adavance-Codes\\stonepuzzle\\src\\stonepuzzle\\images\\win.png"));
        ...
        for (int i = 0; i <4 ; i++) {
            for (int j = 0; j <4 ; j++) {
                JLabel imageLabel = new JLabel(new ImageIcon("C:\\Users\\Student\\Desktop\\Coding\\javasepro\\Adavance-Codes\\stonepuzzle\\src\\stonepuzzle\\images\\"+data[j][i]+".png"));
        ...
        //添加背景大图
        JLabel background = new JLabel(new ImageIcon("C:\\Users\\Student\\Desktop\\Coding\\javasepro\\Adavance-Codes\\stonepuzzle\\src\\stonepuzzle\\images\\background.png"));
